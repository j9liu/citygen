...
class OpenGLRenderer {
  ...
  render(camera: Camera, prog: ShaderProgram, drawables: Array<Drawable>, planeDimensions: vec2,
    ...
    prog.setDimensions(planeDimensions[0], planeDimensions[1]);

    if(showElevation) {
      prog.setShowElevation(1.);
    } else {
      prog.setShowElevation(-1.);
    }
