...
export default class RoadGenerator {
  ...
  public getAllRoads() : Array<Edge> {
    let mrCopy : Array<Edge> = this.mainRoads.slice();
    let srCopy : Array<Edge> = this.smallRoads.slice();
  ...
  private renderEdge(e: Edge) {
    let midpoint : vec2 = e.getMidpoint();
    let midpoint3D : vec3 = vec3.fromValues(midpoint[0],
                                            0,
                                            midpoint[1]);
    ...
    let rotateMat :    mat4 = mat4.create();
